...
<body>
    <div class="background">
        <img src="../Images/ntcbg.jpg" alt="NTC Logo" class="bj1">
    </div>
<nav id="sidebar">
    <ul>
        <li>
        ...
        <li>
            <a href="archive.php" class="<?= basename($_SERVER['PHP_SELF']) == 'archive.php' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3">
            ...
            <form method="GET" action="archive.php" class="search-form">
                ...
                <button type="submit" aria-label="Search">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="#5f6368" viewBox="0 0 24 24">
                        <path d="M15.5 14h-.79l-.28-.27a6.471 6.471 0 001.48-5.34C15.16 5.61 12.55 3 9.5 3S3.84 5.61 3.84 8.39c0 2.78 2.61 5.39 5.66 5.39a6.471 6.471 0 005.34-1.48l.27.28v.79l4.25 4.25 1.49-1.49L15.5 14zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
                    </svg>
                </button>
            </form>
